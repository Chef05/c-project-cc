                                    ...
                                    <td>
                                        <?php if ($participant['checked_in']): ?>
                                            ...
                                            <form method="POST" style="display:inline;">
                                                ...
                                                <button style="color: black;" type="submit" onclick="return confirm('Uncheck this participant?');">🔄 Uncheck</button>
                                            </form>
                                        <?php else: ?>
                                            ❌ No
                                            <form method="POST" style="display:inline;">
                                                ...
                                                <button style="color: black;" type="submit" onclick="return confirm('Check in this participant?');">📌 Check-In</button>
                                            </form>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <?php if ($participant['status'] == 'pending'): ?>
                                            <form method="POST" style="display:inline;">
                                                ...
                                                <button style="color: black;" type="submit" onclick="return confirm('Approve this participant?');">✅ Approve</button>
                                            </form>
                                            <form method="POST" style="display:inline;">
                                                <input type="hidden" name="registration_id" value="<?= $participant['id']; ?>">
                                                <input type="hidden" name="action" value="reject">
                                                <button style="color: black;" type="submit" onclick="return confirm('Reject this participant?');">❌ Reject</button>
                                            </form>
                                        <?php endif; ?>
                                    </td>
                                </tr>
